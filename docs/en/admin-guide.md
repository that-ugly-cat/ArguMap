...
This guide covers everything available to administrators. Everything in the [User Guide](/docs/user-guide) and [Teacher Guide](/docs/teacher-guide) also applies to you.
