...
This guide covers the features available to teachers. Everything in the [User Guide](user-guide.md) also applies to you — this document focuses on course management and student oversight.
